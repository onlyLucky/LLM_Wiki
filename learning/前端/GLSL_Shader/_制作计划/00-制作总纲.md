...
│   ├── day1/02-全屏四边形与UV/（叙事名：UV 观测台）  # 批2
│   ├── day1/03-时间的画面/（叙事名：时间仪器馆）  # 批2
│   ├── day1/04-光标的追随/              # 批2
│   ├── day1/05-点击的涟漪/              # 批2
│   ├── day1/06-滚轮的浪潮/              # 批2
│   ├── day2/01-SDF动物园/              # 批4
...
│   ├── day1/advanced-暗场聚光/         # 批2
│   ├── day1/challenge-极坐标曼陀罗/      # 批2
│   ├── day2/…（basic-全息卡面/advanced-墨纹大理石/challenge-深海回响）# 批4
...
5. **微文案**：demo 用中文诗意命名（「时间仪器馆」而非「time demo」）+ 大写英文角标；操作提示一句中文；错误面板文案可读、可行动。
