...
![反射的物理过程 ](./images/chap7_16.png)

#### BRDF 定义

BRDF 表示从每个入射方向反射到每个出射方向的光的比例：

![BRDF 定义](./images/chap7_16_1.png)
...
![不同弹射次数的全局光照效果对比](./images/chap7_18.png)
...
![连续 PDF 的条件与期望公式](./images/chap7_18_2.png)
